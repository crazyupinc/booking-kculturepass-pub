  ...
  return (
    <div className={styles.eventFestival}>
      ...
      <div className={styles.headerTitle}>
        <div className={styles.div}>
          ...
          <div className={styles.menu}>
            ...
            <div className={styles.introduction}>페스티벌</div>
            <img className={styles.icon} alt="" />
            <div className={styles.introduction1} onClick={onIntroductionClick}>
              전시.체험
            </div>
          </div>
        </div>
      ...
      <div className={styles.titleSectionParent}>
            ...
            <div className={styles.product1Wrapper}>
              <div className={styles.product1}>
                ...
                <div className={styles.ticketInfo}>
                  <div className={styles.placeDate}>Mega Field Music</div>
                  <div className={styles.placeDate1}>Music Festival 2023</div>
                  <div className={styles.placeDate1}>in Han River Park</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className={styles.titleSection}>
          <b className={styles.seeAllProduct}>Tickets now available!</b>
          <div className={styles.productList1}>
            ...
            <div className={styles.product1Wrapper}>
              <div className={styles.product1}>
                ...
                <div className={styles.ticketInfo2}>
                  <div
                    className={styles.placeDate6}
                  >{`Incheon Pentaport `}</div>
                  <div className={styles.placeDate1}>Rock Festival</div>
                  <div className={styles.placeDate1}>in Incheon</div>
                </div>
              </div>
            </div>
            <div className={styles.product1Wrapper}>
              <div className={styles.product1}>
                ...
                />
                <div className={styles.ticketInfo2}>
                  <div className={styles.placeDate6}>RIDE THE BEAT</div>
                  <div className={styles.placeDate1}>Music Festival</div>
                  <div className={styles.placeDate1}>
                    in Jangchung Gymnasium
                  </div>
                </div>
              </div>
            </div>
            <div className={styles.product1Wrapper}>
              <div className={styles.product1}>
                ...
                />
                <div className={styles.ticketInfo2}>
                  <div className={styles.placeDate6}> WATERBOMB 2023</div>
                  <div className={styles.placeDate1}>Summer Festival</div>
