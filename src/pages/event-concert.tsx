      ...
      <div className={styles.headerTitle}>
        <div className={styles.div}>
          ...
          <div className={styles.menu}>
            ...
            <div className={styles.introduction} onClick={onIntroductionClick}>
              페스티벌
            </div>
            <img className={styles.icon} alt="" />
            <div className={styles.introduction} onClick={onIntroduction1Click}>
              전시.체험
            </div>
          </div>
        </div>
      ...
      <div className={styles.titleSectionParent}>
        ...
        <div className={styles.titleSection}>
          ...
          <div className={styles.productList1}>
            ...
            <div
              className={styles.product1Frame}
            ...
            >
              <div className={styles.product1}>
                ...
                />
                <div className={styles.ticketInfo1}>
                  <div className={styles.placeDate3}>SEVENTEEN</div>
